...
public class CamelRouting extends RouteBuilder {
    ...
    public void configure() {
        ...
        from("seda:NeedToCook:queue:test.queue?concurrentConsumers=1").threads(3).delay(600).to("log:throughput?groupSize=10").log("${threadName}").bean(Consumer.class, "cook");
